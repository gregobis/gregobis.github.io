...
const Footer = () => {
    ...
    `)
    const {name, tagline, email} = data.allContentfulMe.nodes[0]
    return (
        <Container>
            <div className="container">
                ...
                <div className="col-sm col-md-3">
                    ...
                    <div className="pr-4">
                        <a href="https://www.instagram.com/guy_pidgeotto" className="social-icon" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="pr-4">
                        <a href="https://twitter.com/greggyonline" className="social-icon" target="_blank" rel="noopener noreferrer">
