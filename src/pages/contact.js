        ...
        <div className="container my-5">
          <div className="row flex-column">
            <div className="col-md-6 mx-auto pb-4">
              ...
              <p class="text-center">
                I'd love to hear about your project! Please reach out to me at{' '}
                <a href="mailto:gregobis@gmail.com">gregobis@gmail.com</a>, and I'll do my best to get back to you
                promptly.
              </p>
            </div>
            <div className="col-md-6 mb-4 mb-md-0 mx-auto">
              <img className="img-responsive" src={imageUrl} alt="Greg Obis" />
            </div>
          </div>
        </div>
      </article>
